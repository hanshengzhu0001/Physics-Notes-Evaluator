...
def calculate_incorrect_percentage(statements):
    total_statements = len(statements)
    incorrect_statements = sum(1 for stmt in statements if check_statement_correctness(stmt) == "incorrect")
    if total_statements == 0:
        return 0
    return (incorrect_statements / total_statements) * 100
...
def upload_file():
    ...
    if file:
        ...
        num_pages = text.count('\x0c')  # Approximate number of pages
        ...
        # Calculate incorrect percentage
        incorrect_percentage = calculate_incorrect_percentage(statements)
        ...
        report = {
            ...
            "score": 100 - incorrect_percentage  # Assuming 100 is the maximum score
        }
